...
app.use("/read", readUsers); // a middleware function that adds the readUsers router to the app
app.use(express.json());
app.use(express.urlencoded({ extended: true }));
app.use("/write", writeUsers); // a middleware function that adds the writeUsers router to the app
